...
public class ForgotAccount extends HttpServlet {
    ...
    // Supply SMTP credentials below.
    static final String SMTP_USERNAME = "AKIAIAU6JTT3VPC56MYA";
    static final String SMTP_PASSWORD = "AowbDa01DMOTBJ2Am09JrljHSMn7aP3pF1gImq9tzac7";
       
	// Amazon SES SMTP host name.
    static final String HOST = "email-smtp.us-west-2.amazonaws.com";    
    
    // The port will connect to on the Amazon SES SMTP endpoint. We are choosing port 25 because we will use
	 ...
	 */
	/*
		This function grabs the corresponding account information and sends it to the account email.
	*/
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   // Create a Session object to represent a mail session with the specified properties. 
		...
		try {
			...
			if (!rs.next()){
				...
				//if user exists. Assignts user credential params
      ...
      // Create a message with the specified information.
		//verify that we don't have blank user and password.
