...
public class Register extends HttpServlet {
	 ...
	 */
	/*
		This function grabs the email, username, and password from the request
		and encrypts the password, inserts into the database, and creates cookies.
	*/
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if (num > 0 || email == "" || username == "" || password == ""){
				...
				//create and push cookies to browser
